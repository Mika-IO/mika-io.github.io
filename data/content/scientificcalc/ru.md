## Для чего нужен научный калькулятор

Введите любое математическое выражение и нажмите «Рассчитать». Поддерживает sin, cos, tan, log, sqrt, pow, PI, E и все стандартные операторы.

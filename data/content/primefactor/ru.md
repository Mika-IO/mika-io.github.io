## Для чего нужен калькулятор простой факторизации

Введите положительное целое число и получите его полную факторизацию на простые числа с показателями степени и всеми делителями.

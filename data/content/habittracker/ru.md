...
Добавляйте привычки и проверяйте их каждый день. Ваши данные сохраняются в вашем браузере локально — ничего не отправляется ни на какой сервер.

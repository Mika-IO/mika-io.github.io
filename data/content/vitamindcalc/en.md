## What Vitamin D Sun Exposure Calculator is for

Find out how many minutes of sun exposure you need to produce adequate vitamin D based on your skin type and UV index.

That is the short version, and for many visitors it is the only part they need — the tool sits at the top of this page, it works immediately, and nothing below is required reading. The rest of this page is here for the times when the answer alone is not enough: when you want to know how the estimate is actually performed, where it stops being reliable, and what to do with the result once you have it.

## How to use it

The controls are deliberately few. You will see 11 controls:

- **Skin type**
- **Sun intensity**
- **Type I — Very light (burns, never tans)**
- **Type II — Light (burns easily)**
- **Type III — Medium (tans gradually)**
- **Type IV — Dark (rarely burns)**
- **Type V-VI — Very dark/dark brown**
- **High**
- **Medium**
- **Low**
- **Calculate**

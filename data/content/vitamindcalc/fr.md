## À quoi sert le calculateur d'exposition au soleil à la vitamine D

Découvrez combien de minutes d’exposition au soleil vous avez besoin pour produire suffisamment de vitamine D en fonction de votre type de peau et de votre indice UV.

Il s'agit de la version courte, et pour de nombreux visiteurs, c'est la seule partie dont ils ont besoin : l'outil se trouve en haut de cette page, il fonctionne immédiatement et rien en dessous n'est obligatoire. Le reste de cette page est là pour les moments où la réponse seule ne suffit pas : lorsque vous souhaitez savoir comment l'estimation est réellement réalisée, où elle cesse d'être fiable et que faire du résultat une fois que vous l'avez.

## Comment l'utiliser

Les contrôles sont volontairement peu nombreux. Vous verrez 11 contrôles :

- **Type de peau**
- **Intensité solaire**
- **Type I — Très léger (brûle, ne bronze jamais)**
- **Type II — Léger (brûle facilement)**
- **Type III — Moyen (bronze progressivement)**
- **Type IV — Foncé (brûle rarement)**
- **Type V-VI — Brun très foncé/foncé**
- **Élevé**
- **Moyen**
- **Faible**
- **Calculer**

Remplissez ce qui s'applique à vous et les résultats sont mis à jour. Rien n'est obligatoire dans le sens d'être soumis n'importe où — si vous changez d'avis, modifiez la valeur et lisez la nouvelle réponse. Il n'y a pas d'étape de sauvegarde, pas de boîte de dialogue de confirmation et aucun moyen de se tromper de façon permanente, donc essayer plusieurs variantes pour voir comment le résultat évolue n'est pas seulement autorisé, c'est généralement la manière la plus informative d'utiliser un outil comme celui-ci.
...
Les chiffres de la santé filtrent des signaux et non des verdicts. Ils sont construits à partir de moyennes de population, ce qui signifie qu’ils décrivent ce qui tend à être vrai pour de grands groupes de personnes plutôt que ce qui est vrai pour vous en particulier. C'est vraiment utile pour repérer quand quelque chose mérite d'être examiné de plus près, et vraiment inutile pour remplacer quelqu'un qui peut réellement vous examiner.
...
Rien ici ne constitue un avis médical, et aucun résultat ne doit être utilisé pour démarrer, arrêter ou modifier un traitement. Les formules de ce type sont généralement dérivées de populations étudiées particulières et peuvent se comporter différemment pour des personnes extérieures à elles : différents âges, différentes compositions corporelles, différents antécédents. Si un résultat vous surprend ou vous inquiète, c'est une raison pour en parler à un clinicien, pas une raison pour faire confiance à ce numéro plutôt qu'à votre propre médecin.

Il vaut la peine d’être explicite quant aux limites, car les outils sont généralement fiables au-delà du point où ils le méritent. Celui-ci est honnête dans ses entrées : donnez-lui des valeurs précises et il vous donne une estimation précise. Il ne peut pas vous dire si les valeurs que vous lui avez données étaient les bonnes, si vous avez posé la bonne question ou si le contexte auquel vous appliquez la réponse a quelque chose d'important que les entrées n'ont jamais capturé. Ce jugement reste avec vous, et c’est la partie qui compte réellement.

## Où cela s'intègre-t-il dans un véritable flux de travail

Des outils comme celui-ci font rarement tout le travail. Le plus souvent, le calculateur d’exposition au soleil à la vitamine D n’est qu’une étape au milieu de quelque chose de plus grand : vous aviez besoin de ce chiffre pour pouvoir continuer ce que vous faisiez réellement. Cela façonne la façon dont la page est construite. Il s'ouvre rapidement, il n'interrompt pas, il ne vous demande pas de vous engager sur quoi que ce soit et il s'écarte dès que vous avez ce que vous êtes venu chercher.
...
La seconde consiste à traiter un chiffre comme une réponse à une question qui n’a jamais été posée. Chaque estimation sur cette page répond à quelque chose de précis et précis. L’appliquer à une question proche mais différente est la manière la plus courante pour les gens de se laisser tromper par un outil qui fonctionnait parfaitement tout le temps. Si vous n'êtes pas sûr que la question que vous vous posez correspond à la question à laquelle l'outil répond, cette incertitude est un signal utile et non un obstacle.

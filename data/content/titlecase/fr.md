## À quoi sert le convertisseur de casse de titre

Collez votre texte et choisissez le style de casse : casse du titre, casse de la phrase, mettre les mots en majuscule ou casse alternée.
...
Le travail sur texte est le genre de tâche qui est triviale une fois et cent fois misérable. Le faire à la main est très bien pour une phrase et sujet aux erreurs pour un document, et les erreurs sont difficiles à repérer : une entrée supprimée silencieusement, un caractère mutilé, un élément d'une longue liste ne correspondant pas au reste.
...
Votre texte est traité comme des caractères et non comme du sens. L’outil n’a aucune opinion sur ce que dit votre contenu, ne le corrige pas et ne tente pas de le comprendre. C’est délibéré : il est plus facile de faire confiance à un comportement mécanique prévisible et de le défaire qu’une routine intelligente qui décide parfois qu’elle sait mieux que vous.

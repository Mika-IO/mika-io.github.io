## Для чего нужен генератор URL-слагов

Введите или вставьте текст, чтобы мгновенно создать URL-адрес. Удаляет акценты, специальные символы и заменяет пробелы дефисами.

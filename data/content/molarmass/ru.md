## Для чего нужен калькулятор молярной массы

Введите химическую формулу (например, H2O, NaCl, C6H12O6), чтобы рассчитать молярную массу в граммах на моль.

## What Pregnancy Week Calculator is for

Enter your last menstrual period (LMP) date to calculate your current pregnancy week, trimester and estimated due date (EDD).
...
Tools like this are rarely the whole job. More often pregnancy week calculator is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

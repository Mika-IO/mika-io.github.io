## What Memory Card Game is for

Flip cards to find matching pairs. Try to match all pairs in as few moves as possible!
...
Tools like this are rarely the whole job. More often memory card game is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

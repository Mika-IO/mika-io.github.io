## What Keyboard Shortcut Reference is for

Browse and search keyboard shortcuts for Windows, Mac, Excel, VS Code and Chrome. Filter by application.
...
Tools like this are rarely the whole job. More often keyboard shortcut reference is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

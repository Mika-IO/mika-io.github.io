## Для чего нужен тестер регулярных выражений

Введите шаблон регулярного выражения, необязательные флаги (g, i, m, s, u) и тестовую строку, чтобы увидеть совпадения в режиме реального времени.

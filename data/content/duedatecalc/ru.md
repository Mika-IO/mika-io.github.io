## Для чего нужен калькулятор срока беременности

Введите первый день последней менструации или дату зачатия, чтобы оценить дату родов.
...
Элементов управления намеренно мало. Вы увидите 6 элементов управления:

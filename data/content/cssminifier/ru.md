## Для чего нужен CSS Minifier

Вставьте CSS и нажмите «Свернуть», чтобы удалить комментарии, пробелы и ненужные символы и уменьшить размер файла.

## Для чего нужен анализатор надежности паролей

Введите пароль, чтобы проанализировать его надежность. Работает полностью в вашем браузере — ничего не отправляется ни на один сервер.
...
Все, что связано с безопасностью и выполняется на чужом сервере, требует от вас полного доверия этому серверу, и весь смысл упражнения обычно заключается в том, что вы не предпочитаете расширять доверие, в котором нет необходимости.
...
Эта страница полностью выполняет свою работу в вашем браузере. Ничего из того, что вы вводите, не передается, и нет компонента на стороне сервера, который мог бы это зарегистрировать. Если речь идет о действительно конфиденциальном материале, загрузите страницу и отключитесь от сети — она продолжит работать, что является убедительным доказательством утверждения.

## Для чего нужен генератор цветовой палитры

Выберите базовый цвет и тип палитры, чтобы создать гармоничную цветовую схему. Щелкните любой образец, чтобы скопировать шестнадцатеричный код.

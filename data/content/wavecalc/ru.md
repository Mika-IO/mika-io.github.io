## Для чего нужен калькулятор волновых свойств

Введите любые два параметра: частоту, длину волны и скорость волны, чтобы вычислить третье, используя v = f, умноженное на длину волны.

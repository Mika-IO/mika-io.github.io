## À quoi sert le calculateur de pH

Entrez une concentration en ions hydrogène [H⁺] ou une concentration en hydroxyde [OH⁻] pour calculer le pH de la solution et sa classification acide/base.
...
- **Type d'entrée**
- **Concentration H⁺ [H⁺] (mol/L)**
- **Concentration en OH⁻ [OH⁻] (mol/L)**
- **valeur du pH (trouver [H⁺])**
- **Valeur**
- **Calculer**

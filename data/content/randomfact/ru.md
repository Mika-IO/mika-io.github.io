## Для чего нужен генератор случайных фактов

Нажмите кнопку, чтобы получить случайный интересный факт. Фильтруйте по категориям, используя кнопки ниже.
...
- **Нажмите кнопку, чтобы узнать случайный факт!**
- **Случайный факт**

## Для чего нужен CSS Box Shadow Generator

Используйте ползунки, чтобы визуально создать тень блока, затем скопируйте сгенерированный код CSS.

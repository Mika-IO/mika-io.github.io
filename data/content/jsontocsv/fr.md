## À quoi sert le convertisseur JSON en CSV

Collez un tableau d'objets JSON pour le convertir au format CSV. Les en-têtes sont automatiquement extraits des clés d'objet.

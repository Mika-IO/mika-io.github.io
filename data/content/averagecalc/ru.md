## Для чего нужен калькулятор средних значений

Введите числа, разделенные запятыми, чтобы вычислить среднее арифметическое, среднее геометрическое, среднее гармоническое, сумму и счет.

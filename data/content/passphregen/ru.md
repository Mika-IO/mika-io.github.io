...
Создайте запоминающуюся парольную фразу, используя случайные слова. Парольные фразы легче запомнить, чем пароли, состоящие из случайных символов, но они так же безопасны.

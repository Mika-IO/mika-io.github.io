## Для чего нужна палитра цветов изображения

Загрузите изображение и щелкните его в любом месте, чтобы выбрать цвет в этой точке. Мгновенно отображает шестнадцатеричные значения, значения RGB и HSL.

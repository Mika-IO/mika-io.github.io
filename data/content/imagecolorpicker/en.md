## What Image Color Picker is for

Upload an image and click anywhere on it to pick the color at that point. Shows hex, RGB and HSL values instantly.
...
The controls are deliberately few. You will see a single input:
...
Tools like this are rarely the whole job. More often image color picker is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

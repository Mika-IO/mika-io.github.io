## Для чего нужна программа проверки цветового контраста

Выберите цвета переднего плана и фона, чтобы проверить коэффициент контрастности и соответствие доступности WCAG 2.1.

## À quoi sert le convertisseur de base numérique

Entrez un numéro et sélectionnez sa base. L'outil affiche instantanément la valeur équivalente dans toutes les bases communes (2, 8, 10, 16) et dans toute base personnalisée.

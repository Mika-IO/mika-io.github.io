## Для чего нужен калькулятор безубыточности

Введите постоянные затраты, продажную цену за единицу и переменную стоимость за единицу, чтобы найти точку безубыточности.

## Для чего нужен конвертер Markdown в HTML

Напишите Markdown слева и увидите визуализированный HTML и предварительный просмотр справа, обновляемый в реальном времени.

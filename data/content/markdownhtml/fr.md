## À quoi sert le convertisseur Markdown en HTML

Écrivez Markdown à gauche et voyez le rendu HTML et l'aperçu en direct à droite, mis à jour en temps réel.
...
Des outils comme celui-ci font rarement tout le travail. Le plus souvent, le convertisseur de démarques en HTML n'est qu'une étape au milieu de quelque chose de plus grand : vous aviez besoin de ce chiffre pour pouvoir continuer ce que vous faisiez réellement. Cela façonne la façon dont la page est construite. Il s'ouvre rapidement, il n'interrompt pas, il ne vous demande pas de vous engager sur quoi que ce soit et il s'écarte dès que vous avez ce que vous êtes venu chercher.

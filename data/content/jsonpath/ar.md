## ما هو اختبار مسار JSON

الصق JSON وأدخل مسار التدوين النقطي (مثل user.address.city أو items[0].name) لاستخراج القيمة في هذا المسار.

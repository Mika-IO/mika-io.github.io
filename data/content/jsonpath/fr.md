## À quoi sert le testeur de chemin JSON

Collez votre JSON et entrez un chemin de notation par points (par exemple user.address.city ou items[0].name) pour extraire la valeur de ce chemin.
...
- **Données JSON**
- **Chemin de clé (notation par points)**
- **Extrait**

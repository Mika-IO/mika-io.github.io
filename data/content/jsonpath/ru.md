## Для чего нужен JSON Path Tester

Вставьте JSON и введите путь в точечной записи (например, user.address.city или items[0].name), чтобы извлечь значение по этому пути.
...
- **Данные JSON**
- **Путь ключа (точечное обозначение)**
- **Извлечение**

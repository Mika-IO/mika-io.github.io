## What Caesar Cipher is for

Enter text and choose a shift value to encode or decode using the Caesar cipher. ROT13 is a Caesar cipher with shift 13.
...
Tools like this are rarely the whole job. More often caesar cipher is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

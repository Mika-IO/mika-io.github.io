## À quoi sert le calculateur d'autorisations de fichiers Unix

Basculez les bits d'autorisation pour le propriétaire, le groupe et d'autres personnes afin de générer le code octal chmod (par exemple, 755) et la notation symbolique.
...
Des outils comme celui-ci font rarement tout le travail. Le plus souvent, le calculateur d'autorisations de fichiers Unix n'est qu'une étape au milieu de quelque chose de plus grand : vous aviez besoin de ce chiffre pour pouvoir continuer ce que vous faisiez réellement. Cela façonne la façon dont la page est construite. Il s'ouvre rapidement, il n'interrompt pas, il ne vous demande pas de vous engager sur quoi que ce soit et il s'écarte dès que vous avez ce que vous êtes venu chercher.

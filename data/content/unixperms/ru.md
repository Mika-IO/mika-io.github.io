## Для чего нужен калькулятор прав доступа к файлам Unix

Переключите биты разрешений для владельца, группы и других, чтобы сгенерировать восьмеричный код chmod (например, 755) и символическое обозначение.

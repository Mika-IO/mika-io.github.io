## Для чего нужен предварительный просмотр шрифтовой пары

Выберите шрифт заголовка и основной шрифт из популярных шрифтов Google, чтобы просмотреть, как они будут выглядеть вместе.
...
- **Шрифт заголовка**
- **Основной шрифт**
- **Шрифты загружаются из CDN Google Fonts**

## Для чего нужен калькулятор экспоненты

Введите базу и показатель степени для вычисления базы^экспоненты. Работает с отрицательными, десятичными и дробными показателями.

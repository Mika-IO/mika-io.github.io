## What Statistics Visualizer is for

Enter comma-separated numbers to calculate mean, median, mode, range, variance, standard deviation and percentiles with a frequency bar chart.

## Для чего нужен калькулятор комбинаций и перестановок

Введите n (общее количество элементов) и r (выбранные элементы), чтобы вычислить количество комбинаций C(n,r) и перестановок P(n,r).

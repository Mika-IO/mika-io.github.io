## À quoi sert le calculateur de combinaison et de permutation

Entrez n (total des éléments) et r (éléments choisis) pour calculer à la fois le nombre de combinaisons C(n,r) et de permutations P(n,r).

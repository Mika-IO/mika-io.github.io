...
قم بلصق HTML لوضع مسافة بادئة تلقائية وتنسيقه ببنية متسقة. اختر مسافة بادئة بمسافتين أو 4 مسافات أو علامة تبويب.

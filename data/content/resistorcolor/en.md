## What Resistor Color Code Calculator is for

Select the color bands on your resistor to decode its resistance value and tolerance. Supports 4-band and 5-band resistors.
...
Working a formula by hand is how you learn it; working it by hand under time pressure is how you get it wrong. Having a reference implementation to check against means a disagreement between your answer and the tool becomes information — one of you made a mistake, and finding out which is the useful part.
...
Constants use standard accepted values and units are stated explicitly rather than assumed, because most errors in this kind of work are unit errors rather than arithmetic ones. If your result is off by a suspiciously round factor, the units are the first thing to check.

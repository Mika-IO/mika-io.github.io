## À quoi sert l'encodeur/décodeur HTML

Collez du HTML pour encoder les caractères spéciaux en tant qu'entités (< → <), ou collez du HTML encodé pour décoder les entités en caractères.

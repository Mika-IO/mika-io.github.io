...
الصق HTML لترميز الأحرف الخاصة ككيانات (< → <)، أو الصق HTML المشفر لفك تشفير الكيانات مرة أخرى إلى الأحرف.

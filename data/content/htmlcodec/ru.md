## Для чего нужен HTML-кодер/декодер

Вставьте HTML, чтобы закодировать специальные символы как объекты (< → <), или вставьте закодированный HTML, чтобы декодировать объекты обратно в символы.

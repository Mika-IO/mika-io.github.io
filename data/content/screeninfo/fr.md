## À quoi sert le vérificateur de résolution d'écran

Visualisez instantanément la résolution de votre écran, la taille de la fenêtre d'affichage du navigateur, le rapport de pixels de l'appareil (DPI) et d'autres informations d'affichage.

## Для чего нужен счетчик монет и банкнот

Введите количество каждого номинала США, чтобы рассчитать общую стоимость. Отлично подходит для подсчета денег.

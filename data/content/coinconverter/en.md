## What Coin and Note Counter is for

Enter the quantity of each US denomination to calculate the total value. Great for counting your cash.
...
Tools like this are rarely the whole job. More often coin and note counter is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

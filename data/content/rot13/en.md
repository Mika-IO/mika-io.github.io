## What ROT13 Encoder / Decoder is for

Type or paste text to encode or decode with ROT13. Since ROT13 is its own inverse, the same operation both encodes and decodes.
...
- **Input (type to encode/decode)**
- **Type here and see ROT13 instantly…**
- **ROT13 output**
...
Tools like this are rarely the whole job. More often rot13 encoder / decoder is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

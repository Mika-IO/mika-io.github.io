## Для чего нужен список дел

Добавляйте задачи и отмечайте их по завершении. Фильтровать по статусу. Ваши задачи сохраняются локально в вашем браузере.
...
- **Готово**
- **Очистить, готово**
- **Сохраняется локально в вашем браузере.**

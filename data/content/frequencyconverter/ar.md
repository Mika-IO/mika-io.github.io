## ما هو محول وحدة التردد

تحويل التردد بين هيرتز (هرتز)، كيلوهرتز (كيلو هرتز)، ميغاهيرتز (MHz)، جيجاهيرتز (غز) وRPM.

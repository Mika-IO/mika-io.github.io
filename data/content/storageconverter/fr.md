## À quoi sert le convertisseur de stockage de données

Convertir entre les unités bit/octet. Prend en charge les unités décimales (SI) (Ko = 1 000 octets) et les unités binaires (KiB = 1 024 octets).
...
Des outils comme celui-ci font rarement tout le travail. Le plus souvent, le convertisseur de stockage de données n'est qu'une étape au milieu de quelque chose de plus grand : vous aviez besoin de ce chiffre pour pouvoir continuer ce que vous faisiez réellement. Cela façonne la façon dont la page est construite. Il s'ouvre rapidement, il n'interrompt pas, il ne vous demande pas de vous engager sur quoi que ce soit et il s'écarte dès que vous avez ce que vous êtes venu chercher.

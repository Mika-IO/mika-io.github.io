## Для чего нужен считыватель QR-кодов

Загрузите изображение, содержащее QR-код, чтобы расшифровать его содержимое. Все работает в вашем браузере — никакие данные не загружаются ни на один сервер.

## À quoi sert le décodeur JWT

Collez un jeton Web JSON (JWT) pour décoder l'en-tête, les revendications de charge utile et l'expiration. Tout fonctionne dans votre navigateur.

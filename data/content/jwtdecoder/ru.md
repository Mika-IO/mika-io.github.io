## Для чего нужен JWT-декодер

Вставьте веб-токен JSON (JWT), чтобы декодировать заголовок, утверждения полезной нагрузки и срок действия. Все работает в вашем браузере.

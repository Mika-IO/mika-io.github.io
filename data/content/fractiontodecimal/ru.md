## Для чего нужен конвертер дробей в десятичные

Введите числитель и знаменатель, чтобы преобразовать дробь в десятичную форму.

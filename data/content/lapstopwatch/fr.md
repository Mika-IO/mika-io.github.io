## À quoi sert le chronomètre avec tours

Un chronomètre de navigateur précis. Commencez le chronométrage, enregistrez les tours et consultez le temps de chaque tour ainsi que le temps total écoulé.
...
Les dates et les heures sont celles où l’intuition confiante va mourir. Les mois ont des longueurs différentes, les années bissextiles brisent l'arithmétique évidente, l'heure d'été saute d'une heure dans un sens ou dans l'autre, et les fuseaux horaires sont politiques plutôt que géographiques. Compter sur vos doigts fonctionne jusqu'au moment où cela ne fonctionne plus en silence.
...
Les calculs utilisent le moteur de date de votre navigateur, qui connaît déjà les règles du calendrier et les décalages pour lesquels votre système est configuré. Cela maintient les résultats cohérents avec tout le reste sur votre appareil, même si cela signifie également qu'une machine avec une mauvaise horloge ou une mauvaise zone produira des réponses correspondantes.

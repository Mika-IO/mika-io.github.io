## What Stopwatch with Laps is for

A precise browser stopwatch. Start timing, record laps, and see each lap time along with the total elapsed time.
...
Tools like this are rarely the whole job. More often stopwatch with laps is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

## Для чего нужен секундомер с кругами

Точный секундомер для браузера. Начинайте отсчет времени, записывайте круги и просматривайте время каждого круга вместе с общим затраченным временем.

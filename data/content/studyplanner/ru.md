## Для чего нужен планировщик исследований

Введите дату экзамена, общее количество необходимых учебных часов и доступные часы в день, чтобы составить персональный график обучения.
...
- **Дата экзамена**
- **Общее необходимое количество учебных часов**
- **Доступны ежедневные часы**
- **Темы для изучения (по одной в строке)**
- **Математика
Физика
Химия
Биология**
...
Подобные инструменты редко решают всю задачу. Чаще всего планировщик занятий — это один из шагов на пути к чему-то большему: вам нужна была эта цифра, чтобы вы могли продолжить то, чем вы на самом деле занимаетесь. Это определяет то, как построена страница. Он открывается быстро, не прерывает, не требует от вас каких-либо обязательств и уходит с дороги в тот момент, когда вы получаете то, за чем пришли.

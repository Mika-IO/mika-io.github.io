## What Net Present Value (NPV) Calculator is for

Calculate the Net Present Value (NPV) of a series of future cash flows to evaluate whether an investment is worthwhile.
...
- **Discount rate (%)**
- **Initial investment**
- **Annual cash flows (one per line)**
- **Calculate**
...
Tools like this are rarely the whole job. More often net present value (npv) calculator is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

## Для чего нужен калькулятор закона Ома

Введите любые два значения напряжения, тока или сопротивления, чтобы вычислить третье. Мощность (ватты) также рассчитывается автоматически.

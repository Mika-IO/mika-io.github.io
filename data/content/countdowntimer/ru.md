## Для чего нужен таймер обратного отсчета

Установите часы, минуты и секунды и начните обратный отсчет. Предупреждение появляется, когда таймер достигает нуля.

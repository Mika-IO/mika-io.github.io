## À quoi sert le calculateur de change

Convertissez entre les principales devises mondiales en utilisant des taux de change indicatifs. Remarque : les taux indiqués sont des exemples de valeurs ; pour connaître les taux en direct, vérifiez votre banque ou un service financier.
...
Les questions d’argent punissent le flou. La différence entre deux hypothèses apparemment plausibles s’aggrave progressivement au fil des années jusqu’à ce que l’écart devienne suffisamment grand pour modifier une décision que vous avez déjà prise. Chiffrer concrètement un choix, même approximatif, transforme un débat sur les sentiments en un débat sur les apports – et les apports peuvent être examinés, contestés et révisés.
...
Traitez le résultat comme un modèle et non comme une promesse. Il reflète exactement les hypothèses que vous avez saisies et rien d'autre : pas de code fiscal spécifique à l'endroit où vous vivez, pas de frais que votre fournisseur peut appliquer, pas d'inflation à moins que vous ne l'ayez saisi et aucun changement de circonstances. Les modèles sont toujours utiles : ils vous permettent de vous demander ce qui devrait être vrai pour que cela fonctionne, ce qui est généralement la question la plus intéressante.

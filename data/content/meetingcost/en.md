## What Meeting Cost Calculator is for

Calculate the real cost of a meeting in salary time. Enter the number of attendees, average annual salary and meeting duration.
...
The controls are deliberately few. You will see 4 controls:
...
Tools like this are rarely the whole job. More often meeting cost calculator is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

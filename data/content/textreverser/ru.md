## Для чего нужен реверс текста

Вставьте текст и выберите режим изменения: перевернуть все символы, изменить порядок слов или изменить порядок строк.

## Для чего нужен калькулятор чистой стоимости

Сложите свои активы (то, чем вы владеете) и обязательства (то, что вы должны), чтобы рассчитать свой собственный капитал.
...
- **Добавьте свои активы и пассивы ниже.**
- **Активы**
- **Обязательства**
- **Добавить объект**
...
Подобные инструменты редко решают всю задачу. Чаще всего калькулятор собственного капитала является шагом к чему-то большему: вам нужна была эта цифра, чтобы вы могли продолжить то, чем вы на самом деле занимаетесь. Это определяет то, как построена страница. Он открывается быстро, не прерывает, не требует от вас каких-либо обязательств и уходит с дороги в тот момент, когда вы получаете то, за чем пришли.

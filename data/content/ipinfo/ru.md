## Для чего нужен мой IP-адрес и информация

Показывает ваш текущий общедоступный IP-адрес и информацию о приблизительном местоположении. Данные извлекаются в реальном времени из общедоступного API поиска IP-адресов.

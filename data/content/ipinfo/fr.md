## À quoi servent mon adresse IP et mes informations

Affiche votre adresse IP publique actuelle et des informations de localisation approximatives. Les données sont récupérées en direct à partir d'une API de recherche d'adresse IP publique.
...
Les petits utilitaires gagnent leur place en étant disponibles dès que vous en avez besoin, sans installation, connexion ou processus d'intégration en cinq étapes. La valeur réside entièrement dans le peu de friction entre vouloir la réponse et l’obtenir.
...
Tout se passe localement dans votre navigateur. Une fois la page chargée, elle n'a plus besoin d'aucun accès au réseau, elle fonctionne donc dans un avion, sur le wifi d'un hôtel qui a cessé de faire semblant, ou avec votre connexion complètement désactivée.

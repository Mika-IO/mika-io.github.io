## Для чего нужен матричный калькулятор

Введите матрицы построчно (значения, разделенные пробелами, по одной строке в строке). Затем выберите операцию.

## Для чего нужен конвертер научной записи

Преобразуйте числа из стандартной формы в экспоненциальное представление (например, 123456789 в 1,23456789 x 10^8).

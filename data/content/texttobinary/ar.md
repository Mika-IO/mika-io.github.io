## ما هو النص إلى محول ثنائي

تحويل النص إلى رمز ثنائي (8 بت لكل حرف) أو فك التشفير الثنائي مرة أخرى إلى نص قابل للقراءة.

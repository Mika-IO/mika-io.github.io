## Для чего нужен калькулятор логарифмов

Введите положительное число x и выберите основание. Поддерживает log₁₀, ln (натуральное бревно), log₂ и любую пользовательскую базу.

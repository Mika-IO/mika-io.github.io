## What Stock Return Calculator is for

Calculate your stock investment profit, total return percentage, and annualized return (CAGR) including dividends received.
...
Tools like this are rarely the whole job. More often stock return calculator is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

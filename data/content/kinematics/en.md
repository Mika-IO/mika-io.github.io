## What Kinematic Equations Solver is for

Enter any 3 of the 5 kinematic variables (initial velocity, final velocity, acceleration, time, displacement) to solve for the unknowns.
...
- **Enter at least 3 of the 5 variables.**
- **Initial velocity v₀**
- **Final velocity v**
- **Acceleration a**
- **Time t**
...
Tools like this are rarely the whole job. More often kinematic equations solver is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

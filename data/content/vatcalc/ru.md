## Для чего нужен калькулятор НДС

Введите цену и ставку НДС. Выберите, добавить ли НДС (нетто → брутто) или удалить его (брутто → нетто).
...
- **Ставка НДС (%)**
- **Направление**
- **Добавить НДС (нетто → брутто)**
- **Удалить НДС (брутто → нетто)**

## À quoi sert le calculateur de TVA

Saisissez un prix et un taux de TVA. Choisissez si vous souhaitez ajouter la TVA (net → brut) ou la supprimer (brut → net).
...
- **Taux de TVA (%)**
- **Orientation**
- **Ajouter la TVA (net → brut)**
- **Supprimer la TVA (brut → net)**

## Для чего нужен генератор случайных команд

Введите имена (по одному в строке) и выберите, сколько команд нужно создать. Генератор случайным образом разбивает их на сбалансированные группы.

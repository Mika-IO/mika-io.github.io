## Для чего нужен счетчик символов и слов

Введите или вставьте текст, чтобы мгновенно подсчитать символы, слова, строки, предложения и получить оценку времени чтения.

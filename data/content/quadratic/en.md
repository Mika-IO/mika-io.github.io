## What Quadratic Equation Solver is for

Enter the coefficients a, b and c of the equation ax² + bx + c = 0 and get the real (or complex) roots instantly.
...
Tools like this are rarely the whole job. More often quadratic equation solver is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

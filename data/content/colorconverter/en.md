## What Color Format Converter is for

Enter a color in HEX (#RRGGBB), RGB, or HSL format to instantly get all equivalent color representations.
...
Tools like this are rarely the whole job. More often color format converter is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

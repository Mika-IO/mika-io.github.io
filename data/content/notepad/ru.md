## Для чего нужен онлайн-блокнот

Создавайте и сохраняйте заметки прямо в браузере. Поддерживается несколько заметок. Автосохранение по мере ввода. Никакой учетной записи не требуется.
...
- **Автоматически сохраняется в памяти браузера**

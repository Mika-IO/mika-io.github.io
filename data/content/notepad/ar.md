## ما هو الغرض من المفكرة عبر الإنترنت؟

قم بإنشاء الملاحظات وحفظها مباشرة في متصفحك. ملاحظات متعددة معتمدة. الحفظ التلقائي أثناء الكتابة. لا حاجة لحساب.
...
- **حذف**
- **ابدأ بكتابة ملاحظتك...**
- ** تم الحفظ تلقائيًا في مساحة تخزين المتصفح **

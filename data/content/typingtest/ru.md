## Для чего нужен тест скорости набора текста

Нажмите «Старт», чтобы начать 60-секундный тест набора текста. Введите отображаемый текст как можно быстрее и точнее.
...
- **Нажмите «Пуск», а затем введите здесь…**
- **Начать**

## What Typing Speed Test is for

Press Start to begin a 60-second typing test. Type the displayed text as fast and accurately as you can.
...
- **Press Start and then type here…**
- **Start**
...
Tools like this are rarely the whole job. More often typing speed test is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

## Для чего нужен калькулятор статистики

Введите числа, разделенные запятыми, и мгновенно получите среднее значение, медиану, моду, стандартное отклонение, дисперсию, минимум, максимум и диапазон.

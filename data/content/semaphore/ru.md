## Для чего нужен флаговый семафорный кодер

Введите текст, чтобы увидеть положение рычага семафора флага для каждой буквы. Используется в морской сигнализации.

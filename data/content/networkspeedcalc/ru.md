## Для чего нужен калькулятор скорости сети

Введите размер файла и скорость соединения, чтобы рассчитать примерное время передачи.

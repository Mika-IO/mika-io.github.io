## Для чего нужна проверка различий

Вставьте исходный и измененный текст, чтобы увидеть построчную разницу, показывающую, что было добавлено, удалено или изменено.

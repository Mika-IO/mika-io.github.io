...
Choisissez vos couleurs et votre type de dégradé, ajustez l'angle et copiez le code CSS généré pour votre projet.
...
- **Type de dégradé**
- **Angle (linéaire)**
- **Code CSS (cliquez pour copier)**
- **Cliquez sur le code CSS pour le copier**

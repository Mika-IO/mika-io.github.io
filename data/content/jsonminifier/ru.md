## Для чего нужны JSON Minifier & Formatter

Вставьте JSON и нажмите «Свернуть», чтобы сжать его, или «Форматировать», чтобы улучшить его с помощью отступов.

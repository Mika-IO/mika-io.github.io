## What Fuel Cost Calculator is for

Enter distance, fuel efficiency and price per gallon or litre to estimate the fuel cost of any trip.
...
Tools like this are rarely the whole job. More often fuel cost calculator is one step in the middle of something larger: you needed this figure so you could get on with the thing you were actually doing. That shapes how the page is built. It opens fast, it does not interrupt, it does not ask you to commit to anything, and it gets out of the way the moment you have what you came for.

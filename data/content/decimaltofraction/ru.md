## Для чего нужен конвертер десятичных дробей

Введите десятичное число и получите точную дробь в простейшей форме.

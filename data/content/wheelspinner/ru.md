## Для чего нужен Wheel Spinner

Вращайте колесо, чтобы принять случайное решение. Настройте параметры, нажав «Изменить».

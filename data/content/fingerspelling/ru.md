## Для чего нужна проверка правописания пальцев ASL

Введите любой текст, чтобы просмотреть описание написания пальца ASL для каждой буквы.
